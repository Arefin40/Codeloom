...
>(({ side = "right", className, children, hideClose = false, ...props }, ref) => (
   <SheetPortal>
      ...
      >
         ...
         {!hideClose && (
            <SheetPrimitive.Close className="flex-center absolute right-4 top-4 size-8 rounded-full hover:bg-muted focus:outline-none disabled:pointer-events-none data-[state=open]:bg-secondary">
